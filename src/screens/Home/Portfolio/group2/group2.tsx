...
export const Group2 = () => {
  ...
  const galleryImages = [
    { id: 1, src: "/port-group2/main.jpg" }, // รูปหลัก
    { id: 2, src: "/port-group2/1.jpg" },
    { id: 3, src: "/port-group2/2.jpg" },
    { id: 4, src: "/port-group2/3.jpg" },
  ];
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-2xl md:text-3xl font-bold mb-8 leading-tight">
            Live Studio Rental & Professional Setup Solutions
          </h1>

          <div className="w-full h-[1px] bg-gray-300 mb-8"></div>

          <div className="text-left space-y-4 text-sm md:text-base text-gray-800 leading-relaxed">
            <p>Premium live studio rentals for educational content and e-learning</p>
            <p>
              Professional live commerce solutions for TikTok, Shopee, and Facebook
              <br />
              Expert studio setup services to create modern and compact workspaces
              <br />
              Versatile video management systems tailored to your specific needs
              <br />
              Multi-platform broadcasting support for YouTube and social media
              <br />
            </p>

            <p>Transform your vision into reality with our professional studio services.</p>
          </div>
        </div>
      </div>
