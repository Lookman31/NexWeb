...
export const Group1 = () => {
  ...
  const galleryImages = [
    { id: 1, src: "/port-group1/main.jpg" }, // รูปหลัก
    { id: 2, src: "/port-group1/1.jpg" },
    { id: 3, src: "/port-group1/2.jpg" },
    { id: 4, src: "/port-group1/3.jpg" },
  ];
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-2xl md:text-3xl font-bold mb-8 leading-tight">
            Professional Event & Live Streaming Solutions
          </h1>

          <div className="w-full h-[1px] bg-gray-300 mb-8"></div>

          <div className="text-left space-y-4 text-sm md:text-base text-gray-800 leading-relaxed">
            <p>Comprehensive production services for all event types</p>
            <p>
              At NEX Studio, we are experts in professional event production
              <br />
              We provide solutions for online seminars and live streaming
              <br />
              We cater to both medium and large-scale productions with ease
              <br />
              Ensuring a seamless experience for high-capacity audiences
              <br />
            </p>

            <p>Contact us today to elevate your next professional event.</p>
          </div>
        </div>
      </div>
