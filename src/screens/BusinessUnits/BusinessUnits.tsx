...
export const BusinessUnits = (): JSX.Element => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 pb-20">
            <div className="lg:w-1/2 space-y-6">
              ...
              <div className="space-y-4 text-lg text-gray-300 leading-relaxed max-w-xl">
                <p>
                  Nex Esports is an esports unit specializing in professional
                  tournament organization.
                </p>
                <p>
                  We handle everything from tournament planning to live
                  broadcasting.
                </p>
                <p>
                  Nex Esports aims to support players, communities, and brands
                  sustainably.
                </p>
              </div>
            </div>
            ...
            >
              <img
                src="/BusinessUnits/business1.jpg"
      ...
      >
        <div className="absolute top-0 left-0 w-full h-1/3 bg-gradient-to-b from-black to-transparent z-[1] opacity-80" />
        ...
        <div className="container mx-auto px-4 relative z-10 py-20">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
            ...
            <div className="lg:w-1/2 space-y-6 text-left">
              ...
              <div className="space-y-4 text-lg text-gray-300 leading-relaxed max-w-xl">
                <p>
                  Nex Production is a creative production unit specializing in
                  professional photo and video shooting.
                </p>
                <p>
                  We provide end-to-end services including photography,
                  videography, and live production.
                </p>
                <p>
                  Delivering powerful visual storytelling for brands, events,
